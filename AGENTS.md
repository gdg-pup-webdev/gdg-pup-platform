# AGENTS.md - GDG PUP Platform (Nexus)
...
- Start with docs/Onboarding for new contributors; CodingGuidelines before non-trivial PRs.
- Contract-first: change packages/*-api-contracts before route/UI drift.
- Root GEMINI.md is architecture constraint text, not a substitute for STATE/INDEX/FLAGS.
