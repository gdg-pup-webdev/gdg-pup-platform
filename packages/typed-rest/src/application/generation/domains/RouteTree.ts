...
export class RouteTree {
  ...
  writeToDiskFast(outputPath: string) {
    ...
    const bodyContent = this.generateBodyString(this.routesDirAbsolute, imports);
  ...
  private generateBodyString(sourceFileDirAbsolute: string, imports: Set<string>): string {
    const parts: string[] = [];
