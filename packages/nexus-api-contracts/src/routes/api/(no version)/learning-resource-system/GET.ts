...
import { learningResource } from "#models/v0/learningResourceSystem/index.js";
...
export const docs_example_response_404 = {
  status: "error",
  message: "Learning resource system not found.",
  errors: [
    {
      title: "Not Found",
      detail: "No learning resource system found for the provided identifier.",
    },
  ],
};
...
export const docs_example_response = {
  status: "success",
  message: "Learning resource summary fetched",
  data: {
    status: "success",
    message: "Learning resources fetched",
    data: [],
  },
};
