import { file } from "#models/v0/fileSystem/index.js";
import { SchemaFactory } from "#utils/schemaFactory.utils.js";

export const body = SchemaFactory.Request.withPayload(file.insertDTO);
...
export const docs_example_response_404 = {
  ...
  errors: [
    {
      title: "Not Found",
      detail: "No file found for the provided identifier.",
    },
  ],
};
