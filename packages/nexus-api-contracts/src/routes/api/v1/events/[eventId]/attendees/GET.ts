import { eventAttendeeRow } from "#models/v1/eventSystem/attendee.js";
...
export const response = {
  200: OpenApiSchemas.Response.paginated(eventAttendeeRow),
...
export const docs_query = {
  ...
  created_at_lte:
    "Optional. Filter check-ins created on/before this date-time.",
};
...
export const docs_example_response_404 = {
  ...
  errors: [
    {
      title: "Not Found",
      detail: "No attendee found for the provided identifier.",
    },
  ],
};
