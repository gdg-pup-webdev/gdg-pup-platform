import { userPoints } from "#models/v1/economySystem/wallet.js"; 
import { OpenApiSchemas } from "@packages/typed-rest/shared";
 
export const query = OpenApiSchemas.Request.Query.paginated() 

export const response = {
  200: OpenApiSchemas.Response.paginated(userPoints),
...
export const docs_example_response_404 = {
  ...
  errors: [
    {
      title: "Not Found",
      detail: "No wallet found for the provided identifier.",
    },
  ],
};
