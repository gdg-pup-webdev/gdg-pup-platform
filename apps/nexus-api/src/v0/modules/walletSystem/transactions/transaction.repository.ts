...
import { TransactionInsert, TransactionRowType } from "./transaction.types";
...
export class TransactionRepository {
  ...
  listTransactionsByUserId = async (
    ...
    pageNumber: number,
    pageSize: number,
  ): RepositoryResultList<TransactionRowType> => {
  ...
  getTransactionById = async (
    id: string,
  ): RepositoryResult<TransactionRowType> => {
