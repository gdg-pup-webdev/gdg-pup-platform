import { DatabaseError_DONT_USE } from "@/v0/errors/HttpError";
...
import { EventInsertDTO, EventType, EventUpdateDTO } from "./event.types";
...
export class EventRepository {
  ...
  ): RepositoryResultList<EventType> => {
