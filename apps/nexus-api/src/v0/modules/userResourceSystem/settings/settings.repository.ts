...
<<<<<<< HEAD:apps/nexus-api/src/modules/userResourceSystem/settings/settings.repository.ts
import {
  Tables,
  TablesInsert,
  TablesUpdate,
...
>>>>>>> dev:apps/nexus-api/src/v0/modules/userResourceSystem/settings/settings.repository.ts
import {
  RepositoryResult,
  RepositoryResultList,
} from "@/v0/types/repository.types.js";
import { SupabaseUtils } from "@/v0/utils/supabase.util";
