...
import { EventHighlightStorageAdapter } from "./infrastructure/EventHighlightStorageAdapter";
...
const storageAdapter = new EventHighlightStorageAdapter(filesModuleController);
...
const updateHighlightUseCase = new UpdateHighlight(
  eventHighlightRepository,
  storageAdapter,
);
