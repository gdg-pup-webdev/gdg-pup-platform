...
import {
  ExternalResourceListFilters,
  ExternalResourceService,
} from "@/modules/learningResourceSystem/externalResources/externalResource.service";
...
export class LearningResourcesHttpController {
  constructor(private readonly resourceService: ExternalResourceService) {}
