        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          <Card className="mb-8">
            ...
            <p className="text-gray-700 leading-relaxed mb-4">
              Google Developer Groups (GDGs) are community groups for college
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
            ...
            <Card>
              ...
              <p className="text-gray-700">
                Meet other students passionate about technology and build
                lasting connections within the developer community.
              </p>
            </Card>
            ...
            <Card>
              ...
              <p className="text-gray-700">
                Develop your technical and leadership skills through
                community-led initiatives and collaborative projects.
              </p>
            </Card>
            ...
            <Card>
              ...
              <p className="text-gray-700">
                Create solutions that matter by applying your skills to
                real-world problems and local community needs.
              </p>
            </Card>
          </div>
