            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
              <div>
                ...
                <p className="text-gray-700 leading-relaxed mb-4">
                  ...
                  family of passionate individuals who support each other's
                  growth and success.
                </p>
                <p className="text-gray-700 leading-relaxed mb-4">
                  Whether you're a beginner taking your first steps in
                  programming or an experienced developer looking to share
                  knowledge, there's a place for you here.
                </p>
