...
export default function ActivateCardPage() {
  ...
  return (
    <div className="min-h-screen bg-zinc-950 text-white font-sans flex items-center justify-center p-4 w-full">
      ...
      <div className="relative z-10 w-full  bg-zinc-900/50 backdrop-blur-xl border border-zinc-800 rounded-2xl p-8 shadow-2xl">
        <div className="text-center mb-8">
          ...
          <p className="text-zinc-500 text-sm mt-2 font-mono">{cardId}</p>
        </div>
        ...
        {authStatus === "checking" ? (
          ...
          <div className="space-y-6">
            ...
            >
              {activateCardMutation.isPending ? (
                <>
