...
export default function MyProjectsPage() {
  ...
  }, [orderedProjectIds, projectIdsFromQuery, projects]);
    ...
    void (async () => {
      try {
        ...
        try {
          ...
          setOrderedProjectIds(projectIdsFromQuery);
        }
      }
    })();
  };
          ...
          <FadeInSection className="p-0" delay={0.02}>
            <div className="flex flex-wrap items-center justify-between gap-3">
              ...
              <div className="flex gap-2">
                ...
                <Link prefetch={false} href="/sparkmates/me">
                  <Button
                    variant="default"
                    size="sm"
                    iconRight={viewIcon}
              ...
              <div className="flex flex-wrap items-start justify-between gap-3">
                <div>
                  ...
                  <p className="mt-1 text-sm text-[#C1C7CD]">
                    Showing {orderedProjects.length} of {totalRecords} projects.
                  </p>
                </div>
                ...
                <>
                  ...
                  {totalPages > 1 ? (
                    ...
                    <p className="mt-6 text-center text-sm text-[#9CA3AF]">
                      You have reached the end of your projects.
                    </p>
                  )}
                </>
              )}
