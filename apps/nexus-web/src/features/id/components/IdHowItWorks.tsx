  ...
  return (
    ...
    >
      <div className="relative h-auto md:h-120 flex flex-col md:flex-row items-stretch">
        ...
        <div className="static md:absolute left-0 top-1/2 md:-translate-y-1/2 w-full md:w-[55%] z-10 pointer-events-none flex justify-start md:justify-start -mt-12 md:mt-0 px-6 md:px-0">
        ...
        <div className="static md:absolute right-0 top-0 bottom-0 w-full md:w-[57%] md:z-20 flex justify-center items-center -mt-6 md:mt-0">
